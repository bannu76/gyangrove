...
## Visuals: Recommended Events are scrolled with details, upcoming events are shown with lazy loading feature for image  to increase performance  

## Issues: URL of google drive Images are not accessble, so Image urls has modified that lead to change in image size (Thumbnails)
